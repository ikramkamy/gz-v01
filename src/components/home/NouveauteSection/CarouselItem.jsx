...
useEffect(()=>{
  ...
  console.log('ShowcategoryName(category)',ShowcategoryName(category))
    ...
    return(  <div id="#carouselitem" className='group relative cursor-pointer bg-productItem
    hover:bg-productItem1 
     ...
     bg-no-repeat bg-cover max-lg:bg-contain bg-center relative '>
          <p className='absolute top-[0%] left-[0%] w-fit pt-8 text-[#ffcd40] pl-2 rotate-[-45deg]'>new</p>            
