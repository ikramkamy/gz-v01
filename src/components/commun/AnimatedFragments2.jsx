import trace1 from "../../assets/pcbuilder/fragments/trace1.png";
import trace2 from "../../assets/pcbuilder/fragments/trace3.png";
import trace3 from "../../assets/pcbuilder/fragments/trace3.png";
import trace6 from "../../assets/pcbuilder/fragments/Tracé 45.png";
import chipintel from "../../assets/pcbuilder/chipiintel.webp";
import trace7 from "../../assets/pcbuilder/fragments/trace7.png";
import trace8 from "../../assets/pcbuilder/fragments/trace1.png";
import { useEffect, useState } from "react";
import { BtnPcBuilder2 } from "../PcBuilder/BtnPCBuilder";


const AnimatedFragments2=({bw2, handelBlackWhite})=>{
...
const handelDynamicPosition=()=>{
    setDynamicPosition({
      ...
      postion6:'-translate-x-[45%] transition ease-in-out delay-150 opacity-0 bg-yellow-500',
...
<div id="btnpcbuilder1"
      className={`${bw2} absolute w-full h-full flex flex-col 
      justify-between max-sm:w-10/12 max-md:mt-10  
       bg-bgpcbuilder3 bg-cover bg-no-repeat bg-center
...
<div className="absolute w-full h-full bg-gradient-to-b from-transparent to-black top-0 "/>
        <div className="flex w-full justify-between " >
          ...
          {/***** image*******/}
           ...
           <div className={`flex w-full justify-center`}>
            {/***** image*******/} 
             ...
             <img src={trace6} alt="gaming zone" className={`${bw2} opacity-20 w-[40%] h-full max-lg:w-[91px]  max-lg:h-[93px] rotate-[313deg] `}/>
          ...
          <div className="flex w-full justify-between m-t-10 ">
            {/***** image*******/} 
             <img src={trace7} alt="gaming zone" className={`opacity-20 max-md:hidden max-sm:ranslate-x-[0%] w-[50px] h-[50px]  rotate-[65deg] ${dynamicPosition.postion7}`}/>
             <BtnPcBuilder2 handelBlackWhite={handelBlackWhite}/>
             
             {/***** image*******/} 

              <img src={trace8} alt="gaming zone" className={`opacity-20 max-sm:translate-x-[-35%]  w-[50px] h-[50px]  max-sm:ranslate-y-[35%] max-sm:rotate-[2deg] ${dynamicPosition.postion8}`}/>
...
export default AnimatedFragments2;