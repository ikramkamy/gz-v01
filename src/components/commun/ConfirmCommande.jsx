...
export default function ConfirmeCommand({name}) {
  ...
  return (
    ...
    {/* {  <Button variant="outlined" onClick={handleClickOpen}>
      ...
      <div className='bg-[#202020]'>
        ...
        <p className='font-bold text-center w-full h-full bg-[#202020] text-redPrimary mt-10'>Your <span className='text-redPrimary'> </span> 
        Your command has been added 
        </p>  
        <div className='text-[11px] text-[#707070]'>click cancel to start all over</div>
        </DialogTitle>
        </div>
        <IconButton
          aria-label="close"
        ...
        <div className='flex justify-center items-center bg-[#202020] w-full h-full text-redPrimary'>
        <svg 
      ...
      <div className='bg-[#202020]'>
        <DialogActions>
          <Button autoFocus onClick={handleClose}>
           <div onClick={()=>handelcancel()} className='text-redPrimary font-bold'> Cancel</div> 
          </Button>
          <Button autoFocus onClick={handleClose}>
           <Link to='/products'  className='text-green-500 font-bold'>Confirme</Link> 
          </Button>
        </DialogActions>
        </div>
      </BootstrapDialog>
