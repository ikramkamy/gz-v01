...
import {BtnLogin, BtnLogin2, BtnLogin3, BtnLogin4 , BtnLogin5,BtnLogin6,BtnLogin7,BtnLogin55} from "../commun/BtnLogin";
const Login=()=>{
    return(
...
<p  className="uppercase text-[10px]">forgot password ?</p>/<p className="uppercase text-[10px]"> don't have and account?</p>
</div>
</div>
          </div>
